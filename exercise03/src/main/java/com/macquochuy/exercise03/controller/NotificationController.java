...
public class NotificationController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Notification> getNotificationById(@PathVariable("id") UuidGenerator notificationId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/notifications/{id}
    public ResponseEntity<Notification> updateNotification(@PathVariable("id") UuidGenerator notificationId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteNotification(@PathVariable("id") UuidGenerator notificationId) {
