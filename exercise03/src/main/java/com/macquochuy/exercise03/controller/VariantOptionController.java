...
public class VariantOptionController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<VariantOption> getVariantOptionById(@PathVariable("id") UuidGenerator variantOptionId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/variantOptions/{id}
    public ResponseEntity<VariantOption> updateVariantOption(@PathVariable("id") UuidGenerator variantOptionId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteVariantOption(@PathVariable("id") UuidGenerator variantOptionId) {
