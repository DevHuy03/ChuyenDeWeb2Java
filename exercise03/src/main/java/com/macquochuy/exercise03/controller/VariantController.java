...
public class VariantController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Variant> getVariantById(@PathVariable("id") UuidGenerator variantId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/variants/{id}
    public ResponseEntity<Variant> updateVariant(@PathVariable("id") UuidGenerator variantId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteVariant(@PathVariable("id") UuidGenerator variantId) {
