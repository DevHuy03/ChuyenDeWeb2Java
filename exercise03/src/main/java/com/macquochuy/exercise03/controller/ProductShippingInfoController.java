...
public class ProductShippingInfoController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductShippingInfo> getProductShippingInfoById(@PathVariable("id") UuidGenerator productShippingInfoId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/productShippingInfos/{id}
    public ResponseEntity<ProductShippingInfo> updateProductShippingInfo(@PathVariable("id") UuidGenerator productShippingInfoId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteProductShippingInfo(@PathVariable("id") UuidGenerator productShippingInfoId) {
