...
public class VariantValueController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<VariantValue> getVariantValueById(@PathVariable("id") UuidGenerator variantValueId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/variantValues/{id}
    public ResponseEntity<VariantValue> updateVariantValue(@PathVariable("id") UuidGenerator variantValueId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteVariantValue(@PathVariable("id") UuidGenerator variantValueId) {
