...
public class CustomerAddressController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<CustomerAddress> getCustomerAddressById(@PathVariable("id") UuidGenerator customerAddressId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/customerAddresses/{id}
    public ResponseEntity<CustomerAddress> updateCustomerAddress(@PathVariable("id") UuidGenerator customerAddressId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteCustomerAddress(@PathVariable("id") UuidGenerator customerAddressId) {
