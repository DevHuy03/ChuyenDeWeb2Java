...
public class SlideShowController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Slideshow> getSlideShowById(@PathVariable("id") UuidGenerator slideShowId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/slideShows/{id}
    public ResponseEntity<Slideshow> updateSlideShow(@PathVariable("id") UuidGenerator slideShowId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteSlideShow(@PathVariable("id") UuidGenerator slideShowId) {
