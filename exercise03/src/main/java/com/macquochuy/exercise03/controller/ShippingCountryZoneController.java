...
public class ShippingCountryZoneController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ShippingCountryZone> getShippingCountryById(@PathVariable("id") UuidGenerator shippingCountryId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/shipping-countries/{id}
    public ResponseEntity<ShippingCountryZone> updateShippingCountry(@PathVariable("id") UuidGenerator shippingCountryId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteShippingCountry(@PathVariable("id") UuidGenerator shippingCountryId) {
