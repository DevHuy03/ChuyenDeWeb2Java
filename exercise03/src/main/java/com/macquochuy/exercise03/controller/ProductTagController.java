...
public class ProductTagController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductTag> getProductTagById(@PathVariable("id") UuidGenerator productTagId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/productTags/{id}
    public ResponseEntity<ProductTag> updateProductTag(@PathVariable("id") UuidGenerator productTagId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteProductTag(@PathVariable("id") UuidGenerator productTagId) {
