...
public class OrderStatusController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<OrderStatus> getOrderStatusById(@PathVariable("id") UuidGenerator orderStatusId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/orderStatuses/{id}
    public ResponseEntity<OrderStatus> updateOrderStatus(@PathVariable("id") UuidGenerator orderStatusId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteOrderStatus(@PathVariable("id") UuidGenerator orderStatusId) {
