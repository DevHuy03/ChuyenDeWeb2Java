...
public class ProductAttributeController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductAttribute> getProductAttributeById(@PathVariable("id") UuidGenerator productAttributeId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/productAttributes/{id}
    public ResponseEntity<ProductAttribute> updateProductAttribute(@PathVariable("id") UuidGenerator productAttributeId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteProductAttribute(@PathVariable("id") UuidGenerator productAttributeId) {
