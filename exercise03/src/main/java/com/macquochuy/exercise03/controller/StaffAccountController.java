...
public class StaffAccountController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<StaffAccount> getStaffAccountById(@PathVariable("id") UuidGenerator staffAccountId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/staffAccounts/{id}
    public ResponseEntity<StaffAccount> updateStaffAccount(@PathVariable("id") UuidGenerator staffAccountId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteStaffAccount(@PathVariable("id") UuidGenerator staffAccountId) {
