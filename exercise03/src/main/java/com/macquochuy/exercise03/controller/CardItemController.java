...
public class CardItemController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<CardItem> getCardItemById(@PathVariable("id") UuidGenerator cardItemId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/cardItems/{id}
    public ResponseEntity<CardItem> updateCardItem(@PathVariable("id") UuidGenerator cardItemId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteCardItem(@PathVariable("id") UuidGenerator cardItemId) {
