...
public class CardController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Card> getCardById(@PathVariable("id") UuidGenerator cardId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/cards/{id}
    public ResponseEntity<Card> updateCard(@PathVariable("id") UuidGenerator cardId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteCard(@PathVariable("id") UuidGenerator cardId) {
