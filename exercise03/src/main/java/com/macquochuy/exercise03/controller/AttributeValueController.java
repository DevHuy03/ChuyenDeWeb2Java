...
import com.macquochuy.exercise03.service.AttributeValueService;
...
public class AttributeValueController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<AttributeValue> getAttributeValueById(@PathVariable("id") UuidGenerator attributeValueId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/attributeValues/{id}
    public ResponseEntity<AttributeValue> updateAttributeValue(@PathVariable("id") UuidGenerator attributeValueId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteAttributeValue(@PathVariable("id") UuidGenerator attributeValueId) {
