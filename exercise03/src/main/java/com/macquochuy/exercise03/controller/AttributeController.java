...
public class AttributeController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Attribute> getAttributeById(@PathVariable("id") UuidGenerator attributeId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/attributes/{id}
    public ResponseEntity<Attribute> updateAttribute(@PathVariable("id") UuidGenerator attributeId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteAttribute(@PathVariable("id") UuidGenerator attributeId) {
