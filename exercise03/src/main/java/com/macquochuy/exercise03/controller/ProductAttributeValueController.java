...
public class ProductAttributeValueController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductAttributeValue> getProductAttributeValueById(@PathVariable("id") UuidGenerator productAttributeValueId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/productAttributeValues/{id}
    public ResponseEntity<ProductAttributeValue> updateProductAttributeValue(@PathVariable("id") UuidGenerator productAttributeValueId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteProductAttributeValue(@PathVariable("id") UuidGenerator productAttributeValueId) {
