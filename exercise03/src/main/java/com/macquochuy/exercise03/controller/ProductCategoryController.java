...
public class ProductCategoryController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductCategory> getProductCategoryById(@PathVariable("id") UuidGenerator productCategoryId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/productCategories/{id}
    public ResponseEntity<ProductCategory> updateProductCategory(@PathVariable("id") UuidGenerator productCategoryId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteProductCategory(@PathVariable("id") UuidGenerator productCategoryId) {
