...
public class GalleryController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Gallery> getGalleryById(@PathVariable("id") UuidGenerator galleryId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/galleries/{id}
    public ResponseEntity<Gallery> updateGallery(@PathVariable("id") UuidGenerator galleryId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteGallery(@PathVariable("id") UuidGenerator galleryId) {
