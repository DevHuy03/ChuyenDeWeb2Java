...
import com.macquochuy.exercise03.Repository.AttributeValueRepository;
...
public class AttributeValueServiceImpl implements AttributeValueService {
    ...
    @Override
    public AttributeValue getAttributeValueById(UuidGenerator attributeValueId) {
    ...
    @Override
    public void deleteAttributeValue(UuidGenerator attributeValueId) {
