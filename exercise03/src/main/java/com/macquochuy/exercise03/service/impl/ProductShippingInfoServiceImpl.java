...
public class ProductShippingInfoServiceImpl implements ProductShippingInfoService {
    ...
    @Override
    public ProductShippingInfo getProductShippingInfoById(UuidGenerator productShippingInfoId) {
    ...
    @Override
    public void deleteProductShippingInfo(UuidGenerator productShippingInfoId) {
