...
public class ProductAttributeValueServiceImpl implements ProductAttributeValueService {
    ...
    @Override
    public ProductAttributeValue getProductAttributeValueById(UuidGenerator productAttributeValueId) {
    ...
    @Override
    public void deleteProductAttributeValue(UuidGenerator productAttributeValueId) {
