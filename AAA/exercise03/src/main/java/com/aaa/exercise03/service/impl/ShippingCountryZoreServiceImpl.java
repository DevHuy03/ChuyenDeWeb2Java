...
import com.aaa.exercise03.Repository.ShippingCountryZoreRepository;
...
public class ShippingCountryZoreServiceImpl implements ShippingCountryZoneService {
    ...
    @Override
    public ShippingCountryZone getShippingCountryById(UUID shippingCountryId) {
    ...
    @Override
    public void deleteShippingCountry(UUID shippingCountryId) {
