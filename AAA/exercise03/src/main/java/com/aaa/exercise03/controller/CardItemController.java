...
import com.aaa.exercise03.service.CardItemService;
...
public class CardItemController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<CardItem> getCardItemById(@PathVariable("id") UUID cardItemId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/cardItems/{id}
    public ResponseEntity<CardItem> updateCardItem(@PathVariable("id") UUID cardItemId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteCardItem(@PathVariable("id") UUID cardItemId) {
