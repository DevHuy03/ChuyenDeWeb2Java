...
import com.aaa.exercise03.service.CouponService;
...
public class CouponController {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/coupons/{id}
    public ResponseEntity<Coupon> updateCoupon(@PathVariable("id") UUID couponId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteCoupon(@PathVariable("id") UUID couponId) {
