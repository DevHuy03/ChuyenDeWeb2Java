...
public class CardController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Card> getCardById(@PathVariable("id") UUID cardId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/cards/{id}
    public ResponseEntity<Card> updateCard(@PathVariable("id") UUID cardId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteCard(@PathVariable("id") UUID cardId) {
