...
import com.aaa.exercise03.service.VariantOptionService;
...
public class VariantOptionController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<VariantOption> getVariantOptionById(@PathVariable("id") UUID variantOptionId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/variantOptions/{id}
    public ResponseEntity<VariantOption> updateVariantOption(@PathVariable("id") UUID variantOptionId,
                                                      @RequestBody VariantOption variantOption) {
        variantOption.setId(variantOptionId);
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteVariantOption(@PathVariable("id") UUID variantOptionId) {
