...
import com.aaa.exercise03.service.SupplyService;
...
public class SupplyController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Supplier> getSupplyById(@PathVariable("id") UUID supplyId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/supplies/{id}
    public ResponseEntity<Supplier> updateSupply(@PathVariable("id") UUID supplyId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteSupply(@PathVariable("id") UUID supplyId) {
