...
import com.macquochuy.exercise03.service.SellService;
...
public class SellController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Sell> getSellById(@PathVariable("id") Integer sellId) {
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/sells/{id}
    public ResponseEntity<Sell> updateSell(@PathVariable("id") Integer sellId,
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteSell(@PathVariable("id") Integer sellId) {
